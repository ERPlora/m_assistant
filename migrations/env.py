...
Auto-generated by ModuleRuntime. Uses per-module version table: alembic_assistant.
"""
...
from assistant.models import (  # noqa: F401
    AssistantActionLog,
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        include_object=_include_tables_only,
    )
...
def _include_tables_only(object, name, type_, reflected, compare_to):
    """Only include tables belonging to the assistant module."""
    if type_ == "table":
